...
export const PROJECTS: Project[] = [
  {
    ...
    "solution": "Designed an AR-based IoT monitoring HUD using Meta Quest 3 and Unity. Integrated ESP8266 sensors with WebSocket communication to visualize real-time gas, temperature, and humidity data through interactive spatial dashboards.",
