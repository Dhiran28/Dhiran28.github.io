...
export const PROJECTS: Project[] = [
  {
    "id": "1785841752569",
    "title": "Industrial IoT AR Monitoring HUD",
    "category": "Augmented Reality, IoT & AI",
    "filter": "XR",
    "description": "Developed an augmented reality heads-up display (HUD) for Meta Quest 3 that visualizes live environmental sensor data from IoT devices. The system streams temperature, humidity, and gas concentration over WebSockets, enabling operators to monitor industrial environments through immersive spatial interfaces.",
    "tags": [
      "Unity",
      "C#",
      "Meta Quest 3",
    ...
    "imageUrl": "https://dhiran28.github.io/Images/Industrial%20IOT%20AR%20Monitoring.png",
    "role": "AI & XR Developer | IoT System Developer",
    "year": "2026",
    "client": "Personal Project",
    "challenge": "Traditional industrial monitoring systems rely on fixed dashboards that require operators to shift attention between equipment and monitoring screens. This separation can delay awareness of environmental changes and reduce situational awareness in safety-critical environments.\n\nThe challenge was to create an immersive monitoring interface capable of displaying live sensor information directly within the user's field of view while maintaining low-latency communication between embedded hardware and the XR application.",
    "solution": "Designed and developed an end-to-end Industrial IoT monitoring system integrating embedded hardware with augmented reality.\n\nEnvironmental data collected from an ESP8266 connected to MQ2 gas and DHT sensors is transmitted in real time through WebSockets to a Unity application running on Meta Quest 3. The application renders a spatial AR dashboard that visualizes gas concentration, temperature, humidity, and system status as interactive holographic panels anchored within the physical environment.\n\nThe architecture enables intuitive monitoring without requiring operators to switch between physical equipment and traditional control panels.\n\nTechnologies Used\nUnity\nC#\nMeta Quest 3\nOpenXR\nESP8266\nWebSocket\nMQ2 Gas Sensor\nDHT11 Temperature & Humidity Sensor\nIoT\nAugmented Reality\nKey Features\nReal-time environmental monitoring\nLive WebSocket communication\nSpatial AR dashboard\nInteractive holographic UI\nGas concentration visualization\nTemperature & humidity monitoring\nSafety status indicators\nLow-latency IoT data streaming\nModular architecture for additional sensors",
    "outcome": "Successfully developed a working proof-of-concept demonstrating seamless integration between IoT devices and augmented reality.\nThe project validates how immersive interfaces can improve industrial monitoring by providing contextual, real-time sensor visualization directly within the operator's workspace. The modular architecture also supports future expansion with AI-based anomaly detection, predictive maintenance, digital twins, and additional industrial sensors.",
    "link": ""
  },
  {
    "id": "first-responder",
